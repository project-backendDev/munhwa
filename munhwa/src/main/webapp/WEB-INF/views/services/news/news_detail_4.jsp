        ...
        <div class="wrap">
            ...
            <div class="cont">
                ...
                <div class="board_detail">
                    <h3>2021년도 기부금 모금액 및 활용실적 명세서 등 공시</h3>
                    <div class="detail_box">
                        <div class="head">
                            <div class="left">
                                <h5>첨부파일</h5>
                                <a href="${pageContext.request.contextPath }/assets/images/2021년도기부금모금액및활용실적명세서등공시.zip" download="">
                                    <h6>2021년도기부금모금액및활용실적명세서등공시.zip</h6>
                            ...
                            <div class="right">
                                <ul>
                                    ...
                                    <li>|</li>
                                    <li><span>조회</span> 343</li>
                                    <li>|</li>
                                    <li><span>등록일</span> 2022-04-29</li>
                                </ul>
                            </div>
                        </div>
                        <div class="content">
                            <p>
                                2021년도 기부금 모금액 및 활용실적 명세서 등 결산서류를 공시합니다.
                            </p>   
                            <br><br>                         
                        ...
                        <div class="previous">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="right">
                                        <a href="${pageContext.request.contextPath }/news_detail_5">
                                            [안내] 제20회 푸른인천글쓰기대회 온라인 공모 접수 안내(~22일)
                                        </a>
                                    </div>
                                </li>                                
                            </ul>
