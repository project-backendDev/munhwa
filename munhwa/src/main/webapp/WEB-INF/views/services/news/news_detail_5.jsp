        ...
        <div class="wrap">
            ...
            <div class="cont">
                ...
                <div class="board_detail">
                    <h3>[안내] 제20회 푸른인천글쓰기대회 온라인 공모 접수 안내(~22일)</h3>
                    <div class="detail_box">
                        <div class="head">
                            <div class="left">
                                <h5>첨부파일</h5>
                                <a href="${pageContext.request.contextPath }/assets/images/imsi5.gif" download="">
                                    <h6>푸른인천글쓰기대회.JPG</h6>
                            ...
                            <div class="right">
                                <ul>
                                    ...
                                    <li>|</li>
                                    <li><span>조회</span> 503</li>
                                    <li>|</li>
                                    <li><span>등록일</span> 2022.04.04</li>
                                </ul>
                            </div>
                        </div>
                        <div class="content">
                            ...
                            <div class="con_img" style="text-align: center;">
                                <img src="${pageContext.request.contextPath }/assets/images/imsi5.gif" style="width: 100%;" alt="">
                            </div>
                        </div>
                        <div class="previous">
                            <ul>
