        ...
        <div class="wrap">
            ...
            <div class="cont">
                ...
                <div class="board_detail">
                    <h3>가천대 길병원, 코로나 확진 산모 출산 100건 기록...신생아 감염 ...</h3>
                        ...
                        <div class="head">
                            ...
                            <div class="right">
                                <ul>
                                    ...
                                    <li>|</li>
                                    <li><span>조회</span> 42</li>
                                    <li>|</li>
                                    <li><span>등록일</span> 2022.06.15</li>
                                </ul>
                            </div>
                        </div>
                        <div class="content">
                            ...
                            <p>
                                <a href="https://www.chosun.com/national/regional/gyeonggi-incheon/2022/06/14/FE65R5GKGVH5VC5KCGLPZ64C6Y/?utm_source=naver&utm_medium=referral&utm_campaign=naver-news" target="_blank">www.chosun.com/national/regional/gyeonggi-incheon/2022/06/14/FE65R5GKGVH5VC5KCGLPZ64C6Y/?utm_source=naver&utm_medium=referral&utm_campaign=naver-news</a><br/>
                                출저 - 조선일보
                            </p>
                        </div>
                        <div class="previous">
                            <ul>
                                <li>
                                    ...
                                    <div class="right">
                                        <a href="${pageContext.request.contextPath }/news_3_detail_3">
                                            길병원 세계 첫 중금속 노출 ‘군날개’ 발생 규명 [출처] - 국민일보...
                                        </a>
                                    </div>
                                </li>
                                ...
                                <li>
                                    ...
                                    <div class="right">
                                        <a href="${pageContext.request.contextPath }/news_3_detail_5">
                                            길병원, 국내 첫 "광역형 국산의료기기 교육·훈련지원센터&qu...
                                        </a>
                                    </div>
                                </li>                                
                            </ul>
