        ...
        <div class="wrap">
            ...
            <div class="cont">
                ...
                <div class="board_detail">
                    <h3>가천문화재단 뉴스레터 2022년 4월호</h3>
                    <div class="detail_box">
                        <div class="head">
                            <div class="left">
                                <h5>첨부파일</h5>
                                <a href="${pageContext.request.contextPath }/assets/images/new4.jpg" download="">
                                    <h6>가천문화재단-뉴스레터-제31호(2022년-4월호).jpg  </h6>
                            ...
                            <div class="right">
                                <ul>
                                    ...
                                    <li>|</li>
                                    <li><span>조회</span> 149</li>
                                    <li>|</li>
                                    <li><span>등록일</span> 2022.04.01</li>
                                </ul>
                            </div>
                        </div>
                        <div class="content">
                            <div class="con_img" style="text-align: center;">
                                <img src="${pageContext.request.contextPath }/assets/images/new4.jpg" style="width: 100%;" alt="">
                            </div>
                        </div>
                        <div class="previous">
                            <ul>
