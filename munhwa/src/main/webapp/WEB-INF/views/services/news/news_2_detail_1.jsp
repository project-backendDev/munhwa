        ...
        <div class="wrap">
            ...
            <div class="cont">
                ...
                <div class="board_detail">
                    <h3>가천문화재단 뉴스레터 2022년 8월호</h3>
                    <div class="detail_box">
                        <div class="head">
                            <div class="left">
                                <h5>첨부파일</h5>
                                <a href="${pageContext.request.contextPath }/assets/images/new8.jpg" download="">
                                    <h6>가천문화재단-뉴스레터-제35호(2022년-8월호).jpg  </h6>
                        ...
                        <div class="content">
                            <div class="con_img" style="text-align: center;">
                                <img src="${pageContext.request.contextPath }/assets/images/new8.jpg" style="width: 100%;" alt="">
                            </div>
                        </div>
                        <div class="previous">
                            <ul>
